...
@Module({
  imports: [ AccessModule, UserinfoModule, FlatinfoModule, MulterModule.register({
    dest:"./Static"
  }), ComunalModule, SearchModule, MailModule, SubsModule, AcceptSubsModule, CitizenModule, AgreementModule, ChatModule, FeaturesModule, UsersubsModule, FeedbackModule, RatingModule, ReportsModule, AdminModule],
  controllers: [AppController, ImgController],
  providers: [AppService, ImgService, Service],
  exports:[AppService]
})
